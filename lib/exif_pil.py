...
class PILExifReader:
    ...
    def read_capture_time(self):
        ...
        if time_tag in self._exif:
            ...
            capture_time = 0
            return datetime.datetime.strptime('1972_11_11_18_54_55', '%Y_%m_%d_%H_%M_%S')

        # return as datetime object
        capd=datetime.datetime.strptime(capture_time, '%Y_%m_%d_%H_%M_%S')
        #capd=capd.replace(microsecond=0)
        return capd
